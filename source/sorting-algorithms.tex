...
\tcode{ValueSwappable}~(17.6.3.2). The type of \tcode{*first} shall satisfy the requirements of \linebreak \tcode{MoveConstructible} (Table~20) and of \tcode{MoveAssignable} (Table~22).
